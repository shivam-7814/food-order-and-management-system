<?php include('../food-order/config/constants.php');
        ...
        //verify internet connection
              ...
              function is_connected() {
                  $connected = @fsockopen("www.google.com", 80); // Try to connect to Google
                  if ($connected) {
                      fclose($connected);
              ...
              if (is_connected()) {
                ...
                $_SESSION['internet-verify']= "<div style='color: red; text-align:center; class='no-internet'  font-size:12px;'>No internet Connection !</div>";
              }
...
<html lang="en">
  <head>
    ...
    <title>Login - Food Order System</title>
            ...
            <link rel="stylesheet" href="../food-order/css/homepage.css" />
            <link rel="stylesheet" href="../food-order/css/admin.css" />

    <link rel="icon" type="image/x-icon" href="../food-order/images/homepage/imgs/burger-svg.svg">
  </head>
  <body>
    <div class="main-container">
      ...
      <div class="outer-nav">
        ...
        <div class="login">
            ...
            <div class="main-box-user-login">
            <p class="sign" align="center">User Login</p>
            <p class="notify-box">
            <?php
               if(isset( $_SESSION['internet-verify']))
            {
                echo  $_SESSION['internet-verify'];
                unset( $_SESSION['internet-verify']);
            }
            ...
            ?>
                   ...
                   <form action="send-otp.php" method="POST" class="form1 mail-box">
                   <input type="email" name="email" placeholder="Enter Gmail" class="un" id="emailInput" value="<?php echo isset($_POST['email']) ? $_POST['email'] : ''; ?>" required pattern="^[a-zA-Z0-9._%+-]+@gmail\.com$"><br>
                    <input type="submit" id="sendOtpBtn" class="login-submit login-submit-user" value="Send Otp" >
                    </form>
                      <a href="<?php echo SITEURL ;?>admin/index.php" class="admin-login-btn"> Admin Login</a>
                        <!-- Hidden OTP Section -->
                      <form action="verify-otp.php" class="form1" method="POST" >
                       <div class="otp-section flex-center" style=" flex-direction: column; margin-left:12px; margin-top: 50px;">
                        <input type="text" name="otp" id="otp-input" placeholder="Enter OTP" maxlength="6" class="un" required ><br>
                        <p>
                          
                        </p>
                        <input type="submit" name="verifyOtp" class="login-submit" value="Verify Otp">
                      </div>
                    </form>
                   <p class="going-down-btn"> <span class="enter-otp-text" style="   color: rgb(204, 204, 204);">Click Here Enter Otp</span>
                   <p class="expand-btn">
                     <svg width="32px" height="32px" viewBox="-0.5 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M12 22.4199C17.5228 22.4199 22 17.9428 22 12.4199C22 6.89707 17.5228 2.41992 12 2.41992C6.47715 2.41992 2 6.89707 2 12.4199C2 17.9428 6.47715 22.4199 12 22.4199Z" stroke="#F17228" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M16 10.99L13.13 14.05C12.9858 14.2058 12.811 14.3298 12.6166 14.4148C12.4221 14.4998 12.2122 14.5437 12 14.5437C11.7878 14.5437 11.5779 14.4998 11.3834 14.4148C11.189 14.3298 11.0142 14.2058 10.87 14.05L8 10.99" stroke="#F17228" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                   </p>
            ...
            <p class="text-center dev-name-p">Created By - <a href="https://www.linkedin.com/in/shivam7814/" class="" target="_blank">Shivam Maurya</a></p>
        </div>
    ...
    <div class="footer-details-container">
          ...
          <div class="footer-details">
              ...
              <div class="bottom-footer">
                ...
                <p>All rights Reserved <span class="copy-logo" >&copy;</span> Bhojan <span  class="bhojanlogo-pc-bottom">
                <svg height="28px"  width="28px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <circle style="fill:#FEE187;" cx="256" cy="256" r="256"></circle> <circle style="fill:#FEE187;" cx="256" cy="256" r="256"></circle> </g> <g> <path style="fill:#FFB30E;" d="M276.97,511.14c130.212-10.559,232.865-118.551,234.977-250.98L395.609,145.318l-52.336,33.671 l7.482,7.482l-87.126,52.012L88.319,278.919l23.961,49.916l-7.702,6.703L276.97,511.14z"></path> <polygon style="fill:#FFB30E;" points="315.763,135.327 302.545,114.352 294.357,85.333 240.674,89.347 315.763,162.047 "></polygon> </g> <path style="fill:#930000;" d="M322.801,175.84c-2.167,0-4.184-1.37-4.906-3.539L290.63,90.505h-46.697 c-2.857,0-5.172-2.315-5.172-5.172s2.315-5.172,5.172-5.172h50.424c2.226,0,4.203,1.424,4.906,3.537l28.444,85.333 c0.903,2.708-0.56,5.639-3.27,6.54C323.894,175.754,323.343,175.84,322.801,175.84z"></path> <path style="fill:#C92F00;" d="M286.689,341.333h80.843c3.986,0,7.34-2.979,7.811-6.937l21.83-183.377 c0.557-4.68-3.098-8.797-7.811-8.797H264.857c-4.713,0-8.37,4.117-7.811,8.797l21.83,183.377 C279.349,338.354,282.705,341.333,286.689,341.333z"></path> <path style="fill:#930000;" d="M262.465,196.525l16.413,137.871c0.471,3.956,3.827,6.937,7.811,6.937h80.844 c3.986,0,7.34-2.981,7.811-6.937l16.413-137.871H262.465z"></path> <path style="fill:#E09112;" d="M99.556,256c0-47.128,38.205-85.333,85.333-85.333s85.333,38.205,85.333,85.333H99.556z"></path> <path style="fill:#F17228;" d="M184.889,170.667c-0.433,0-0.86,0.026-1.293,0.033V256h86.626 C270.222,208.872,232.017,170.667,184.889,170.667z"></path> <path style="fill:#E09112;" d="M96.97,305.457c0,7.127,0.855,14.053,2.462,20.685c2.232,9.218,10.464,15.725,19.947,15.725h131.019 c9.483,0,17.715-6.508,19.947-15.725c1.607-6.632,2.462-13.559,2.462-20.685H96.97z"></path> <path style="fill:#F17228;" d="M183.596,305.457v36.411h66.801c9.483,0,17.715-6.508,19.947-15.725 c1.607-6.632,2.462-13.559,2.462-20.685L183.596,305.457L183.596,305.457z"></path> <path style="fill:#B54324;" d="M99.556,284.444h170.667c7.854,0,14.222-6.368,14.222-14.222l0,0c0-7.854-6.368-14.222-14.222-14.222 H99.556c-7.854,0-14.222,6.368-14.222,14.222l0,0C85.333,278.076,91.701,284.444,99.556,284.444z"></path> <path style="fill:#C92F00;" d="M270.222,256h-86.626v28.444h86.626c7.854,0,14.222-6.368,14.222-14.222 C284.444,262.368,278.076,256,270.222,256z"></path> <path style="fill:#D35933;" d="M99.556,312.889h170.667c7.854,0,14.222-6.368,14.222-14.222l0,0c0-7.854-6.368-14.222-14.222-14.222 H99.556c-7.854,0-14.222,6.368-14.222,14.222l0,0C85.333,306.521,91.701,312.889,99.556,312.889z"></path> <path style="fill:#B54324;" d="M270.222,284.444h-86.626v28.444h86.626c7.854,0,14.222-6.368,14.222-14.222 S278.076,284.444,270.222,284.444z"></path> </g></svg>

                </span>  2025</p>
                <div class="dev-name flex-box-center">
                  <p>Made with </p> 
                  <svg  width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M2 9.1371C2 14 6.01943 16.5914 8.96173 18.9109C10 19.7294 11 20.5 12 20.5C13 20.5 14 19.7294 15.0383 18.9109C17.9806 16.5914 22 14 22 9.1371C22 4.27416 16.4998 0.825464 12 5.50063C7.50016 0.825464 2 4.27416 2 9.1371Z" fill="#FFB30E"></path> </g></svg>
                    
                    <p>by </p>
                  <a href="https://www.linkedin.com/in/shivam7814/" target="_blank"> Shivam Maurya</a>
                </div>
        ...
        <!-- script -->
         <script>
             ...
             const form1 = document.querySelector('.mail-box');
             const adminLoginBtn = document.querySelector('.admin-login-btn');  
              const userLoginContainer = document.querySelector('.main-box-user-login');
              const otpBox = document.querySelector('.otp-section');
              const otpText = document.querySelector('.enter-otp-text');


               expandBtn.addEventListener('click', function(){

                form1.style.display = 'none';
                userLoginContainer.style.height = '340px';
                adminLoginBtn.style.display = 'none';

                otpText.innerText = "Enter Otp Now";
              })
              
              const noInternet= document.querySelector('.no-internet');

              if(noInternet && noInternet.textContent.includes("No internet Connection !")){
